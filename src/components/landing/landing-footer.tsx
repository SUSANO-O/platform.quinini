    ...
    <footer style={{ borderColor: 'var(--border)' }} className="border-t">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div>
            <h4 className="landing-label mb-3">{t('legal')}</h4>
            <ul className="space-y-2 landing-body-sm landing-muted">
        ...
        <div className="mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 landing-label landing-muted" style={{ borderTop: '1px solid var(--border)' }}>
