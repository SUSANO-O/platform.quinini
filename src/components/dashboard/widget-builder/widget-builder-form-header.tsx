...
export function WidgetBuilderFormHeader({
  ...
  if (wizardStep === 0) {
    return (
      <>
        <div className="badge-primary mb-2 w-fit text-[10px]">Widget</div>
        <h1 className="widget-builder-page-title" data-tour="widget-builder-header">
          {editWidgetId ? (
            <>
        ...
        <p className="widget-builder-page-desc">
          {editWidgetId
        ...
        {editWidgetId ? (
          <p className="mb-4 m-0">
            <Link href="/dashboard/widgets" className="text-[11px] font-semibold landing-link-accent no-underline">
