...
export { GRACE_PERIOD_DAYS, graceEndsAtSeconds, resolveSubscriptionAccess } from './subscription-access';
import { resolveSubscriptionAccess } from './subscription-access';
import { resolveLifecycle } from '@/modules/account-lifecycle/domain/lifecycle';
...
export async function getSubscriptionStatus(userId: string) {
  ...
  return {
    ...access,
    /** Tramo del ciclo de vida por falta de pago (gris / precios / aviso de borrado). */
    lifecycle: resolveLifecycle(doc),
