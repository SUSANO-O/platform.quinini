        ...
        if (editId) {
          ...
          if (!wRes.ok) {
            ...
            setCfg({
              ...
              idleReengageMinutes: typeof (widget as { idleReengageMinutes?: number }).idleReengageMinutes === 'number' ? (widget as { idleReengageMinutes?: number }).idleReengageMinutes! : 10,
              idleReengageMessage: String((widget as { idleReengageMessage?: string }).idleReengageMessage ?? DEFAULT_WIDGET_CONFIG.idleReengageMessage),
