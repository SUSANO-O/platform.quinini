...
(function () {
  ...
  function cssForRoot(rootId, cfg) {
    var dark =
      cfg.theme === 'dark'
        ? '#' + rootId + ' .afhub-chat { background:#13131a; box-shadow:0 8px 40px rgba(0,0,0,.55); border:1px solid rgba(255,255,255,.06); }' +
          ...
          '#' + rootId + ' .afhub-feedback-btn:hover { color:#eef2ff; }' +
          '#' + rootId + ' .afhub-feedback-btn.active { opacity:1; background:transparent; }' +
    ...
    return '' +
      ...
      '#' + rootId + ' .afhub-msg-copy-btn { width:18px; height:18px; }' +
      '#' + rootId + ' .afhub-msg-copy-btn svg { width:12px; height:12px; }' +
      '#' + rootId + ' .afhub-msg-copy-btn.active { color:' + cfg.color + '; }' +
      ...
      '#' + rootId + ' .afhub-feedback-row { align-self:flex-start; display:inline-flex; gap:4px; margin:-6px 0 2px 2px; }' +
      '#' + rootId + ' .afhub-feedback-btn { width:18px; height:18px; border-radius:0; border:none; background:transparent; color:#9ca3af; font-size:12px; line-height:1; display:inline-flex; align-items:center; justify-content:center; cursor:pointer; transition:color .12s ease,opacity .12s ease; padding:0; opacity:.7; }' +
      '#' + rootId + ' .afhub-feedback-btn:hover { color:#111827; opacity:1; }' +
      '#' + rootId + ' .afhub-feedback-btn[data-value="up"].active { color:#16a34a; opacity:1; }' +
      '#' + rootId + ' .afhub-feedback-btn[data-value="down"].active { color:#dc2626; opacity:1; }' +
